...
//Output - Returns 0 if the first n bytes are the same.  
//If we hit a byte that is not the same in both we return -1 
//if the value in the a byte is less than the byte value in b, 
//or 1 if the byte value in b is less than the byte value in a.
...
//Output - If the return value is less than 0 it means the character in s1 is less than the character in s2.  
//If it is greater than 0, the character in s1 is greater than the character in s2.  If 0, the strings are the same
...
//Translates a string into an integer
//Negative numbers allowed
//Input - str: Any numeric string. Any character not a numeric number returns as 0.
//Example: char s[] = "-492b" atoi(s) will return -4290 as an int
int atoi(const char* str);

//Removes the last character in a string
//Input - dest: Any string
//Output - A pointer to the array that now holds the new string
//Example: You have a string = Array => strdel(string) = Arra;
char* strdel(char* dest);

//Only runs until last character in the string is a white space/null
//Input - destination string, source string
//Output - destination string with the first word of the source string
char* strparse(char* d, const char* s);

//Only gets the second word/first parameter in a string
//Input - destination string, source string
//Output - destination string with the second word of the source string
char* parameter1(char* d, const char* s);

//Only gets the third word/second parameter in a string
//Input - destination string, source string
//Output - destination string with the third word of the source string
char* parameter1(char* d, const char* s);
#endif
